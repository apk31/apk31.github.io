...
<head>
    <title>MyShop Movie Streaming</title>
...
<body>
    ...
    <h1 align=center>Video Streaming</h1>
    <table style="table-layout: fixed;">
        <tr>
            <td><a class="atxt" href="netflix.html">
                    <div class="card">
            ...
            <td><a class="atxt" href="disney.html">
                    <div class="card">
            ...
            <td><a class="atxt" href="comingsoon.html">
                    <div class="card">
